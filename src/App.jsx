...
import CaseStudy from './blogs/CaseStudy'
import Fatwas from './blogs/Fatwas';
import MythBusterBlog from './blogs/MythBusterBlog';
import HalalInvestingIndia from './blogs/HalalInvestingIndia';
import BioTechHalalBlog from './blogs/BioTechHalalBlog';
import ZakatInvestingBlog from './blogs/ZakatInvestingBlog ';
import WealthAndFaithBlog from './blogs/WealthAndFaithBlog';
import HalalMutualFundsVsStocks from './blogs/HalalMutualFundsVsStocks';
import HalalStatusChangeBlog from './blogs/HalalStatusChangeBlog';
import BeginnerMistakesBlog from './blogs/BeginnerMistakesBlog';
import FutureOfHalalInvestingBlog from './blogs/FutureOfHalalInvestingBlog';
        ...
        <Router>
            <div>
                <Routes>
                    ...
                    <Route path="/myth" element={<MythBusterBlog />} />
                    <Route path="/halalIndia" element={<HalalInvestingIndia />} />
                    <Route path="/Biotech" element={<BioTechHalalBlog />} />
                    <Route path="/Zakat" element={<ZakatInvestingBlog />} />
                    <Route path="/wealth-faith-roadmap" element={<WealthAndFaithBlog />} />
                    <Route path="/mutual-funds-vs-stocks" element={<HalalMutualFundsVsStocks />} />
                    <Route path="/halal-status-changes" element={<HalalStatusChangeBlog />} />
                    <Route path="/beginner-mistakes" element={<BeginnerMistakesBlog />} />
                    <Route path="/future-halal-investing" element={<FutureOfHalalInvestingBlog />} />
