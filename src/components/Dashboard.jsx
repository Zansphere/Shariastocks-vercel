...
const Dashboard = () => {
  ...
  const handleInputChange = (e) => {
    ...
    if (value) {
      ...
      const filteredCompanies = companies
        .filter(company =>
          company["NAME OF COMPANY"].toUpperCase().includes(upperValue) ||
          company.SYMBOL.includes(upperValue)
        )
        .slice(0, 6);
  ...
  return (
    <main className="bg-gray-50 min-h-screen" data-testid="dashboard-page">
      <Helmet>
      ...
      <Suspense fallback={<div className="flex items-center justify-center h-screen">
        <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-indigo-500" data-testid="suspense-loader"></div>
      </div>}>
        <HeaderDash />
        <main className="max-w-7xl mx-auto pb-16">
          ...
          <section className="relative px-4 py-8 md:py-16 ">
            ...
            <div className="relative max-w-3xl mx-auto text-center space-y-8">
              ...
              <div className="space-y-4">
                <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent" data-testid="hero-title">
                  Invest with Purpose
                </h1>
              ...
              >
                <div className="relative group">
                  ...
                  {isSearchActive && suggestions.length > 0 && (
                    <ul className="absolute w-full mt-2 bg-white rounded-xl shadow-lg border border-gray-100 z-20" data-testid="search-suggestions-list">
                      {suggestions.map((suggestion) => (
                        <li
                          key={suggestion.SYMBOL}
                          data-testid={`search-suggestion-item-${suggestion.SYMBOL}`}
                          onClick={(e) => {
                            e.stopPropagation();
                            e.preventDefault();
          ...
          <section className="w-full max-w-6xl mx-auto px-4 mt-12" data-testid="trending-stocks-section">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              <div className="p-6 pb-4">
                <div className="flex justify-between items-center mb-6">
                  <div className="flex items-center">
                    <TrendingUp className="w-5 h-5 text-indigo-600 mr-2" />
                    <h2 className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent" data-testid="trending-stocks-title">
                      Trending Stocks
                    </h2>
                  </div>
                  ...
                  <div className="flex space-x-1">
                    <button 
                      ...
                      data-testid="trending-prev-button"
                    >
                    ...
                    <button 
                      ...
                      data-testid="trending-next-button"
                    >
                ...
                <div className="relative">          
                  ...
                  >
                    {trendingStocks.map((stock, index) => (
                      <div 
                        key={stock.symbol}
                        data-testid={`trending-stock-card-${stock.symbol}`}
                  ...
                  <div className="flex justify-center mt-4 gap-2">
                    {[...Array(2)].map((_, i) => (
                      <button
                        key={i}
                        data-testid={`trending-slider-dot-${i}`}
          ...
          <section className="w-full max-w-6xl mx-auto px-4 mt-12" data-testid="halal-stocks-section">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              <div className="p-6">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold bg-gradient-to-r from-green-600 to-teal-600 bg-clip-text text-transparent" data-testid="halal-stocks-title">
                      Top 10 Halal Stocks
                    </h2>
                ...
                <div className="overflow-hidden relative">
                  ...
                  {/* Table Content */}
                  <div className="space-y-1 mt-3" data-testid="halal-stocks-list">
                    {halalStocks.map((stock, index) => {
                      ...
                      return (
                        <div 
                          key={stock.symbol}
                          data-testid={`halal-stock-row-${stock.symbol}`}
                  ...
                  {user?.subscription?.plan === 'free' && (
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none" style={{ top: '120px' }} data-testid="upgrade-overlay">
                      <div className="bg-white/80 backdrop-blur-md rounded-xl p-6 shadow-lg text-center max-w-md pointer-events-auto border border-gray-100">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 justify-center">
                          <button 
                            ...
                            data-testid="upgrade-overlay-button"
                          >
                            Upgrade Now
                          </button>
                          <button 
                            ...
                            data-testid="learn-more-overlay-button"
                          >
                            Learn More
                          </button>
                        </div>
                  ...
                  {user?.subscription?.plan === 'free' ? (
                    <>
                      ...
                      <button 
                        ...
                        data-testid="upgrade-promo-footer-button"
                      >
                        Upgrade to Premium
                      </button>
                    </>
          ...
          {/* Footer */}
          <footer className="mt-16 text-center text-gray-500 text-sm border-t border-gray-100 pt-6 px-4" data-testid="dashboard-footer">
            <div className="max-w-6xl mx-auto">
              <div className="flex flex-col md:flex-row justify-between items-center mb-6">
                ...
                <div className="flex space-x-4">
                  {['About', 'Privacy', 'Terms', 'Blogs', 'FAQ'].map((item, index) => (
                    <a key={index} href={`/${item.toLowerCase()}`} className="text-gray-600 hover:text-indigo-600 transition-colors" data-testid={`footer-link-${item.toLowerCase()}`}>
                      {item}
                    </a>
                  ))}
                </div>
              ...
              <div className="border-t border-gray-100 pt-4 pb-8">
                <p data-testid="footer-copyright">© 2025 Zansphere Private Limited. All rights reserved.</p>
              </div>
            </div>
          </footer>
        </main>
